...
android {
    ...
    productFlavors {
        create("development") { dimension = "environment"; applicationIdSuffix = ".dev"; resValue("string", "app_name", "KidsGame DEV") }
        create("staging") { dimension = "environment"; applicationIdSuffix = ".staging"; resValue("string", "app_name", "KidsGame STAGING") }
        create("production") { dimension = "environment"; resValue("string", "app_name", "KidsGame") }
    }
